...
const float mlx90393_tconv[8][4] = {
    /* DIG_FILT = 0 */
    {11.27, 11.84, 13.00, 15.30},
    /* DIG_FILT = 1 */
    {11.46, 12.23, 13.76, 16.84},
    /* DIG_FILT = 2 */
    {11.84, 13.00, 15.30, 19.91},
    /* DIG_FILT = 3 */
    {12.61, 14.53, 18.37, 26.05},
    /* DIG_FILT = 4 */
    {14.15, 17.60, 24.52, 38.34},
    /* DIG_FILT = 5 */
    {17.22, 23.75, 36.80, 62.92},
    /* DIG_FILT = 6 */
    {23.36, 36.04, 61.38, 112.07},
    /* DIF_FILT = 7 */
    {35.65, 60.61, 110.53, 210.37},
};
